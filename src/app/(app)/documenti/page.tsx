...
import { centsEur, DOC_KIND_LABEL, STATO } from "@/lib/invoicing/client";
  ...
  return (
    <div>
      <PageHeader title="Documenti fiscali" subtitle="Fatture, note di credito e ricevute — con stato SDI"
        actions={<button onClick={exportCsv} className="rounded-lg border border-line px-3 py-2 text-sm font-semibold text-txt hover:bg-wash">Esporta CSV</button>} />
