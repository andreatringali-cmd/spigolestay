  ...
  return (
    <div>
      ...
      <section className="mb-7">
        ...
        {/* Regola weekend */}
        <div className="mb-3 flex flex-wrap items-center gap-2 rounded-xl border border-line bg-surface px-3 py-2.5 text-sm shadow-sm">
            ...
            <table className="w-full min-w-[680px] text-sm">
              ...
              <tbody>
                {types.map((rt) => {
                  ...
                  return (
                    <tr key={rt.id} className="border-b border-line last:border-0 hover:bg-wash">
      ...
      <section>
        ...
        <p className="mb-3 text-xs text-dim">{t("Cosa vedrebbe l'ospite, giorno per giorno, con il piano scelto. In")} <b className="text-focus">{t("evidenza")}</b> {t("i prezzi forzati dal calendario.")}</p>
