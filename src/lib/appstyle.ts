...
export const PALETTES: Pal[] = [
  ...
  // ── Foglio bianco (24/09/2026): 4 identità nuove, non varianti di tinta ma di CARATTERE.
  // "Stampa" = editoriale/da rivista, carta calda opaca, inchiostro quasi nero, un solo
  // rosso da timbro postale. "Cemento Pop" = brutalista, cemento neutro + un pop shock
  // di magenta elettrico. "Terminale" = CRT/hacker, nero vero con bagliore verde fosforo
  // (wash/line tinti di verde invece che neutri, per un effetto "glow" sui riquadri).
  // "Vino & Oro" = boutique/lounge, aubergine profondo e oro champagne.
  { name: "Stampa", swatch: ["#F7F3EA", "#FFFFFF", "#B3241A"], vars: { "--paper": "#F7F3EA", "--surface": "#FFFFFF", "--wash": "#EFE9DB", "--line": "#DAD2BF", "--txt": "#1A1714", "--dim": "#5B5348", "--faint": "#9C9284", "--focus": "#B3241A" }, dark: { "--paper": "#14110D", "--surface": "#1E1A15", "--wash": "#262019", "--line": "#362E24", "--txt": "#F1EAD9", "--dim": "#C2B8A4", "--faint": "#7C7365", "--focus": "#E2493C" } },
  { name: "Cemento Pop", swatch: ["#EDEAE6", "#F8F7F5", "#D6007F"], vars: { "--paper": "#EDEAE6", "--surface": "#F8F7F5", "--wash": "#E2DFDA", "--line": "#D2CEC7", "--txt": "#17161A", "--dim": "#57555C", "--faint": "#9B98A0", "--focus": "#D6007F" }, dark: { "--paper": "#131215", "--surface": "#1C1B1F", "--wash": "#242327", "--line": "#322F35", "--txt": "#EDEBEE", "--dim": "#A6A3AC", "--faint": "#66636C", "--focus": "#FF3FA8" } },
  { name: "Terminale", swatch: ["#050706", "#0C100D", "#22E27A"], vars: { "--paper": "#F3FAF6", "--surface": "#FFFFFF", "--wash": "rgba(34,197,122,.07)", "--line": "rgba(34,197,122,.18)", "--txt": "#0B2A1B", "--dim": "#3E7057", "--faint": "#8FBDA4", "--focus": "#0E9D5B" }, dark: { "--paper": "#050706", "--surface": "#0C100D", "--wash": "rgba(46,224,154,.05)", "--line": "rgba(46,224,154,.16)", "--txt": "#DFFCEB", "--dim": "#8FE3B8", "--faint": "#4B7A64", "--focus": "#22E27A" } },
  { name: "Vino & Oro", swatch: ["#170B12", "#241019", "#D8A550"], vars: { "--paper": "#FBF1EC", "--surface": "rgba(255,255,255,.95)", "--wash": "rgba(122,31,61,.08)", "--line": "rgba(122,31,61,.18)", "--txt": "#2B1119", "--dim": "#7A4550", "--faint": "#C9A3AC", "--focus": "#8C2A4A" }, dark: { "--paper": "#170B12", "--surface": "rgba(244,196,120,.05)", "--wash": "rgba(244,196,120,.035)", "--line": "rgba(244,196,120,.16)", "--txt": "#F6E9D8", "--dim": "#C9A98A", "--faint": "#7A5C55", "--focus": "#D8A550" } },
];
