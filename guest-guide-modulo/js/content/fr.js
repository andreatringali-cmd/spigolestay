...
window.I18N.fr = {
    ...
    centralperk: {
      ...
      contacts: {
        ...
        items: [
          ...
          { h: "Téléphone", p: "Pour les urgences et les communications rapides.", actions: [{ label: "Stefano", href: "{phone}", type: "tel", icon: "phone" }, { label: "Greta", href: "{phoneGreta}", type: "tel", icon: "phone" }] },
  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        { h: "Bar Ulma", p: "Via Giuseppe Testaferrata, 18 — à deux pas de chez nous — [u]Fermé le dimanche[/u]", actions: [{ label: "Ouvrir la carte", href: "https://www.google.com/maps/place/Bar+Ulma/@37.0728936,15.2826342,17z/data=!3m1!4b1!4m6!3m5!1s0x1313ce9bea0ad7f9:0x27634dfbce8517a3!8m2!3d37.0728936!4d15.2826342!16s%2Fg%2F1tj70tqr", icon: "pin" }] },
        { h: "Bar Milano", p: "Via Giuseppe di Natale, 16 — options sans gluten et sans lactose disponibles — [u]Fermé le dimanche[/u]", actions: [{ label: "Ouvrir la carte", href: "https://www.google.com/maps/place/Bar+Milano/@37.0722014,15.2836088,17z/data=!3m1!4b1!4m6!3m5!1s0x1313ce9be3177055:0x79dbcf2cb6326ec4!8m2!3d37.0722014!4d15.2836088!16s%2Fg%2F11b6j85d63", icon: "pin" }] },
        { h: "Blend | La Miscela del Gusto", p: "Corso Gelone, 77 — [u]Fermé le mardi[/u]", actions: [{ label: "Ouvrir la carte", href: "https://www.google.com/maps/place/Blend+-+La+miscela+del+gusto/@37.0713338,15.2829346,17z/data=!3m1!4b1!4m6!3m5!1s0x1313cfb2a11c99cb:0xaec137875a966b3f!8m2!3d37.0713338!4d15.2829346!16s%2Fg%2F11r_x62945", icon: "pin" }] }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        { h: "WhatsApp, Telegram, Viber", p: "Le moyen le plus rapide de nous joindre.", actions: [{ label: "Ouvrir WhatsApp", href: "{whatsapp}", type: "wa", icon: "chat" }] },
        { h: "Téléphone", p: "Pour les urgences et les communications rapides.", actions: [{ label: "Greta", href: "{phoneGreta}", type: "tel", icon: "phone" }, { label: "Andrea", href: "{phone}", type: "tel", icon: "phone" }] },
        { h: "Email", p: "{email}", actions: [{ label: "Écrire un email", href: "{email}", type: "mail", icon: "info" }] },
